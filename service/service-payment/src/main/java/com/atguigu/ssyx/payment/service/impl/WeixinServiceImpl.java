...
public class WeixinServiceImpl implements WeixinService {
    ...
    public Map<String, String> createJsapi(String orderNo) {
        //1.向payment表中加入支付记录 目前支付状态，正在支付中
...
//			paramMap.put("openid", "o1R-t5trto9c5sdYt6l1ncGmY5iY");
        ...
        UserLoginVo userLoginVo = (UserLoginVo)redisTemplate.opsForValue()
                .get("user:login:" + paymentInfo.getUserId());
    ...
    public Map<String, String> queryPayStatus(String orderNo) {
        ...
        resultMap.put("mch_id", ConstantPropertiesUtils.PARTNER);
        ...
        try {
            client.setXmlParam(WXPayUtil.generateSignedXml(resultMap, ConstantPropertiesUtils.PARTNERKEY));
            client.setHttps(true);
            client.post();
